...
var appVersion = getVersionFromGitTag();
var mainPlugins = [
    ...
    values: [
      {
        ...
        replacement: process.env.VITE_APP_GTAG_MEASUREMENT_ID
      },
      {
        find: /<api_secret>/g,
        replacement: process.env.VITE_APP_GTAG_API_SECRET
      }
    ]
  }),
...
var preloadPlugins = [externalizeDepsPlugin()];
var rendererPlugins = [
  vue(),
  UnoCSS({
...
var electron_vite_config_default = defineConfig({
  main: {
    ...
    build: {
      ...
      minify: process.env.NODE_ENV === "development" ? void 0 : "terser"
    },
    plugins: mainPlugins,
    define: {
