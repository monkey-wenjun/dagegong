            ...
            <div>
              <div font-size-14px mb8px>
                ...
                <el-tooltip
                  effect="light"
                  placement="bottom-start"
                  @show="gtagRenderer('tooltip_show_about_auto_run_time')"
                >
                  <template #content>
                    <div>
                      启用后，AI自动找工作功能将只在指定的时间段和星期几内运行。<br />
              ...
              <div>
                <el-checkbox
                  v-model="formContent.autoRunTimeEnabled"
                  @change="
                    (v) => {
                      gtagRenderer('auto_run_time_enabled_changed', { v })
                    }
                  "
                >
                  启用自动运行时间控制
              ...
              <div pl-1.5em mt12px font-size-12px>
                <div
                  :style="{
                    color: formContent.autoRunTimeEnabled ? '' : '#aaa'
                  }"
                >
                  <div flex items-center gap-16px mb12px>
                    ...
                    <el-time-select
                      ...
                      placeholder="开始时间"
                      @change="(v) => gtagRenderer('auto_run_start_time_changed', { v })"
                    />
                    <span>至</span>
                    <el-time-select
                      v-model="formContent.autoRunEndTime"
                      :disabled="!formContent.autoRunTimeEnabled"
                      start="00:00"
                      step="00:30"
                      end="23:30"
                      placeholder="结束时间"
                      @change="(v) => gtagRenderer('auto_run_end_time_changed', { v })"
                    />
                  </div>
                  <div flex items-center gap-16px>
                    ...
                    <el-checkbox-group 
                      ...
                      :disabled="!formContent.autoRunTimeEnabled"
                      @change="(v) => gtagRenderer('auto_run_weekdays_changed', { v })"
                    >
